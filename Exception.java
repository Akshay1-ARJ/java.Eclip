package com.xworkz.tasks;
	...
	import org.w3c.dom.DOMException;
		...
		public class Exception {
			...
			public void Method9() {
				System.out.println("Running");
				throw new ServiceConfigurationError("shubham");
			}
			...
			public void Method24() {
				System.out.println("Running");
				throw new Error("Akshay");
			}

			public void Method25() {
				System.out.println("Running");
				throw new Error("AKKI");
			}
			...
			{
				System.out.println("creating exception by JAXBException class");
				
				throw new  JAXBException(null, null, null);
			}
